...
// Always start a new remote-desktop session window maximized. Global local
// option, off by default.
const String kOptionStartRemoteMaximized = "start-remote-maximized";
...
// instead of sending it to the remote. Must match `OPTION_CTRL_ARROW_LOCAL`
// in src/keyboard.rs.
const String kOptionCtrlArrowLocal = "ctrl-arrow-local";
